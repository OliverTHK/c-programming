...
int main()
{
   ...
   while (numBoxes != -1)
   {
     if (numBoxes >= 0)
     {
      ...
      cout << "Invalid! Number of boxes is negative value!" << endl;
   ...
   numSeller -= 1; //numSeller-- can also be used
   if (numSeller == 0)
      cout << "\nNo boxes were sold.\n";
   else
   {  // WRITE CODE TO ASSIGN averageBoxes THE COMPUTED AVERAGE NUMBER
      ...
      // OF BOXES SOLD PER SELLER.
      cout << "The average number of boxes sold by the " << numSeller;
      cout << " sellers was " << averageBoxes << ".\n";
   }
